...
void show_owners(string owners[], string cartype[], string mycartype, int &ncars);
...
int main()
{
    ...
    show_cars(owners, cartype, color, mileage, passengers, numcars);
 	...
 	show_owners(owners, cartype, "Honda", numcars);
 	show_owners(owners, cartype, "Buick", numcars);
 	show_owners(owners, cartype, "Chevy", numcars);
